 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW                        // DIGA-Tech:
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW                        // DIGA-Tech:
#define Y_MAX_ENDSTOP_HIT_STATE HIGH
#define Z_MIN_ENDSTOP_HIT_STATE LOW                        // DIGA-Tech:
#define Z_MAX_ENDSTOP_HIT_STATE HIGH                       // DIGA-Tech: set to HIGH due to usage of probe
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH                 // DIGA-Tech: set to HIGH due to usage of probe
 ...
 */
#define Z_MIN_PROBE_PIN 19                                 // DIGA-Tech: use Z max endstop (19)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   10 // (mm) Z Clearance for Deploy/Stow                                    // DIGA-Tech:
#define Z_CLEARANCE_BETWEEN_PROBES  5 // (mm) Z Clearance between probe points                               // DIGA-Tech:
#define Z_CLEARANCE_MULTI_PROBE     5 // (mm) Z Clearance between multiple probes                            // DIGA-Tech:
...
#define Z_SAFE_HOMING                                      // DIGA-Tech:
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER  // (mm) X point for Z homing         // DIGA-Tech:
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER  // (mm) Y point for Z homing         // DIGA-Tech:
